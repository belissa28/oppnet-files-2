...
server.set('views',__dirname+'/public')//this tells express to find our static files in the public folder


server.use(bodyParser.json())
server.use(bodyParser.urlencoded({extended:false}))
//server responds to the get request to the homepage

//with a function that takes in a request object
//a response object
